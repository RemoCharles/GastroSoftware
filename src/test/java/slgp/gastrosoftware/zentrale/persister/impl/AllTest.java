...
@RunWith(Suite.class)
@Suite.SuiteClasses({BestellungDAOTest.class, PersonDAOTest.class, LoginDAOTest.class, KontaktDAOTest.class, KonsumartikelDAOTest.class, AdresseDAOTest.class, TischRechnungDAOTest.class, MAAbrechnungDAOTest.class, BestellPositionDAOImplTest.class})
