...
public class PersonTest {
	...
	public void testPersonLoeschen() {
		...
		try {
			...
			logger.error("Person konnte nicht gel�scht werden" + e);
			System.out.println("Person konnte nicht gel�scht werden" + e);
	...
	public void testPersonAdresseAendern() {
		...
		try {
			...
			logger.error("Adresse konnte nicht ge�ndert werden" + e);
			System.out.println("Adresse konnte nicht ge�ndert werden" + e);
